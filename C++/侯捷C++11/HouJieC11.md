- [Hou Jie C++ 11 新特性](#hou-jie-c-11-新特性)
  - [演进 环境 与资源](#演进-环境-与资源)
  ...
  - [一个move-aware的class](#一个move-aware的class)
    - [实现](#实现)
    - [测试](#测试)
- [内存管理-从平地到万丈高楼](#内存管理-从平地到万丈高楼)
  - [第一讲: primitives](#第一讲-primitives)
- [C++ 11/14 高级编程 : Boost 程序库探秘](#c-1114-高级编程--boost-程序库探秘)
  - [Chap 1 : 全新的C++语言](#chap-1--全新的c语言)
    - [左值和右值](#左值和右值)
    - [自动类型推导](#自动类型推导)
    - [面向过程编程](#面向过程编程)
    - [OO 编程](#oo-编程)
    ...
    - [函数式编程](#函数式编程)
    - [其他特性](#其他特性)
  - [Chap 2: Intro to 模板元编程](#chap-2-intro-to-模板元编程)
    - [常用语言元素](#常用语言元素)
    - [元数据](#元数据)
    - [元函数](#元函数)
    - [元函数的转发](#元函数的转发)
