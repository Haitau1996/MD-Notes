...
- [CS 61A: Structure and Interpretation of Computer Programs](#cs-61a-structure-and-interpretation-of-computer-programs)
  - [Lecture 1: Intro](#lecture-1-intro)
    - [What is Computer Science](#what-is-computer-science)
    - [What is CS 61 About](#what-is-cs-61-about)
    - [表达式](#表达式)
      - [剖析表达式调用过程](#剖析表达式调用过程)
      - [Functions , Objects and Interpreters](#functions--objects-and-interpreters)
  - [Lecture 2: Names, Assignment, and User-Defined Functions](#lecture-2-names-assignment-and-user-defined-functions)
      - [表达式的类型](#表达式的类型)
      - [Environment Diagrams](#environment-diagrams)
    - [Defining Functions](#defining-functions)
      - [calling User-Defined Functions](#calling-user-defined-functions)
      - [在环境中查找 names](#在环境中查找-names)
  - [Lecture 3: Control](#lecture-3-control)
      - [`print` 和 evaluate 的区别](#print-和-evaluate-的区别)
      - [Pure Functions & Non-Pure Functions](#pure-functions--non-pure-functions)
    - [Environment](#environment)
    - [一些python 特性](#一些python-特性)
      - [Operators](#operators)
      - [多个返回值](#多个返回值)
      - [运行 python 文件中的代码](#运行-python-文件中的代码)
      - [statements](#statements)
    - [迭代](#迭代)
      - [While Statement 的执行规则](#while-statement-的执行规则)
  - [Lecture 4: High-Order Functions](#lecture-4-high-order-functions)
    - [Designing Functions](#designing-functions)
    - [High-Order functions](#high-order-functions)
      - [The Purpose of High-Order Functions](#the-purpose-of-high-order-functions)
    - [lambda 表达式](#lambda-表达式)
      - [lambda 表达式 和 def 语句的比较](#lambda-表达式-和-def-语句的比较)
  - [Lecture 5: 环境](#lecture-5-环境)
    - [High-Order Functions 的调用环境](#high-order-functions-的调用环境)
    - [Nested definition 的环境](#nested-definition-的环境)
    - [Local Names](#local-names)
    - [Function Composition](#function-composition)
  - [Lecture 06: Iteration](#lecture-06-iteration)
    - [Return statement](#return-statement)
    - [Self-Reference](#self-reference)
  - [Lecture 7: Recursion](#lecture-7-recursion)
    - [递归函数](#递归函数)
      - [递归函数的环境图解](#递归函数的环境图解)
      - [递归函数正确性的检查](#递归函数正确性的检查)
    - [将递归转为迭代](#将递归转为迭代)
  - [Lecture 8: 树递归](#lecture-8-树递归)
    - [递归调用的顺序](#递归调用的顺序)
    - [树递归](#树递归)
    - [例: counting partitions](#例-counting-partitions)
  - [Lecture 9: Function Examples](#lecture-9-function-examples)
    - [函数抽象](#函数抽象)
    - [TDD](#tdd)
    - [函数科里化(currying)](#函数科里化currying)
    - [函数修饰器(decorator)](#函数修饰器decorator)
  - [Lecture 10: Data Abstraction](#lecture-10-data-abstraction)
    - [Pair](#pair)
    - [Abstraction Barriers](#abstraction-barriers)
    - [Data Representations](#data-representations)
  - [Lecture 11: Containers](#lecture-11-containers)
    - [List](#list)
    ...
    - [String](#string)
    - [字典](#字典)
  - [Lecture 12: trees](#lecture-12-trees)
    - [Box and Pointer Notation](#box-and-pointer-notation)
    - [Slicing(切片)](#slicing切片)
    - [处理容器的值](#处理容器的值)
    - [Trees](#trees)
      - [实现一个树](#实现一个树)
      - [Tree Processing](#tree-processing)
  - [Lecture 13: Mutable Values](#lecture-13-mutable-values)
    - [Python 中的对象](#python-中的对象)
    - [Mutation 操作](#mutation-操作)
    - [Tuples (immutable sequences)](#tuples-immutable-sequences)
  - [Lecture 14: Mutable Functions](#lecture-14-mutable-functions)
    - [Nonlocal 语句的影响](#nonlocal-语句的影响)
    - [Multiple Mutable Functions](#multiple-mutable-functions)
  - [Lecture 15 : Objects](#lecture-15--objects)
    - [Object-Oriented Programming](#object-oriented-programming)
    - [Classes](#classes)
      - [Identity](#identity)
      - [Methods](#methods)
      - [Attributes](#attributes)
  - [Lecture 16: 继承](#lecture-16-继承)
    - [继承](#继承)
    - [面向对象设计](#面向对象设计)
      - [继承和组合](#继承和组合)
    - [多继承](#多继承)
  - [Lecture 17: Representation](#lecture-17-representation)
    - [String Representation](#string-representation)
    - [polymorphic(多态的) Functions](#polymorphic多态的-functions)
      - [interface](#interface)
    - [特殊的方法](#特殊的方法)
  - [Lecture 18: Growth](#lecture-18-growth)
    - [Measuring Efficiency](#measuring-efficiency)
    - [Memoizaiton](#memoizaiton)
    - [Space](#space)
        - [Active environments](#active-environments)
    - [Time](#time)
    - [Order Of Growth](#order-of-growth)
    - [不同增长率的比较](#不同增长率的比较)
  - [Lecture 19 : Composition](#lecture-19--composition)
    - [链表](#链表)
    - [Property Methods](#property-methods)
    - [Tree](#tree)
    - [树的操作](#树的操作)
  - [Lecture 20 : Ordered Sets](#lecture-20--ordered-sets)
    - [Set as Linked List](#set-as-linked-list)
    - [Set Operations](#set-operations)
    - [Set Mutation](#set-mutation)
  - [Lecture 21: Tree Sets](#lecture-21-tree-sets)
    - [二叉树](#二叉树)
    - [二叉搜索树](#二叉搜索树)
    - [BST 中的查找](#bst-中的查找)
  - [Lecture 24: Scheme](#lecture-24-scheme)
    - [Scheme](#scheme)
    - [Special Forms](#special-forms)
    - [lambda 表达式](#lambda-表达式-1)
  - [Lecture 25: Exceptions](#lecture-25-exceptions)
    - [Raise Exception(抛出异常)](#raise-exception抛出异常)
    - [异常处理](#异常处理)
  - [Lecture 26: Calculator](#lecture-26-calculator)
    - [解释器](#解释器)
    - [语法分析](#语法分析)
    - [Calculator](#calculator)
    - [The eval function](#the-eval-function)
    - [Iteractive Interpreters](#iteractive-interpreters)
  - [Lecture 27: interpreters](#lecture-27-interpreters)
    - [Special Form](#special-form)
    - [Logical Special Forms](#logical-special-forms)
    - [Quotation](#quotation)
    - [lambda 表达式](#lambda-表达式-2)
    - [Define Expression](#define-expression)
  - [Lecture 28 : Tail Call](#lecture-28--tail-call)
    - [Dynamic Scope](#dynamic-scope)
    - [Tail Recursion](#tail-recursion)
    - [Tail Call](#tail-call)
    - [Map and Reduce](#map-and-reduce)
  - [Lecture 29: Macros](#lecture-29-macros)
    - [Program as Data](#program-as-data)
    - [Macro](#macro)
      - [Macros Perform Code Transformations](#macros-perform-code-transformations)
    - [For Macro](#for-macro)
    - [Quasi-Quotaition](#quasi-quotaition)
  - [Lecture 30 Iterator](#lecture-30-iterator)
    - [数据处理](#数据处理)
    - [迭代器](#迭代器)
    - [For statement](#for-statement-1)
    - [Built-In Iterator Functions](#built-in-iterator-functions)
    - [Generator](#generator)
    - [Generators & Iterators](#generators--iterators)
  - [Lecture 31 : Streams](#lecture-31--streams)
    - [Sequence Operation](#sequence-operation)
    - [Stream](#stream)
    - [Integer Stream](#integer-stream)
    - [Stream Processing](#stream-processing)
    - [Higher-Order Functions](#higher-order-functions)
    - [使用 Delay 和 Force 实现stream](#使用-delay-和-force-实现stream)
  - [Lecture 32: Declarative Languages](#lecture-32-declarative-languages)
    - [Database Management Systems](#database-management-systems)
    - [Structured Query Language (SQL)](#structured-query-language-sql)
      - [Select Value](#select-value)
    - [Projecting Tables](#projecting-tables)
    - [Arithmetic](#arithmetic)
  - [Lecture 33: Table](#lecture-33-table)
  ...
  - [Lecture 34 : Aggregation(聚合操作)](#lecture-34--aggregation聚合操作)
    - [Group](#group)
      - [selecting Groups](#selecting-groups)
  - [Lecture 35 : Data Base](#lecture-35--data-base)
    - [Modifying Tables](#modifying-tables)
    - [Python and SQL](#python-and-sql)
    - [SQL 注入攻击](#sql-注入攻击)
  - [Lecture 36 : Distributed Data](#lecture-36--distributed-data)
    - [Computer Systems](#computer-systems)
      - [例: Unix 操作系统](#例-unix-操作系统)
    - [Apache Spark](#apache-spark)
      - [Apache Spark 执行模型](#apache-spark-执行模型)
    - [MapReduce](#mapreduce)
      - [MapReduce Evaluation Model](#mapreduce-evaluation-model)
  - [Lecture 37: NLP](#lecture-37-nlp)
## Lecture 1: Intro
